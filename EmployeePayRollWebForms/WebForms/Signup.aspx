<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" Inherits="EmployeePayRollWebForms.WebForms.Signup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sec3">
        ...
        <p style="margin-bottom: 19px"> to continue to Employee Payroll
    </div>
     <div>
         <asp:TextBox ID="TextBox2" type="text" placeholder="First name" name="firstname" runat="server" required="required" ToolTip="Please Enter First Name" OnTextChanged="TextBox2_TextChanged" Height="33px" Width="134px"></asp:TextBox>
       <asp:TextBox ID="TextBox3" type="text" placeholder="Last name" name="lastname" runat="server" required="required" ToolTip="Please Enter Last Name" Height="31px" style="margin-top: 0px" Width="141px"></asp:TextBox>        
